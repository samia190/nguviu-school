...
2. Backend returns imageUrl like: `https://kangarugirls.sc.ke/uploads/file.jpg`
...
1. **Upload Endpoint** (`/api/files/upload`):
   ...
   url: toAbsoluteUrl(req, doc.url)  // Could be https://kangarugirls.sc.ke/uploads/...
   ```

2. **Frontend receives** from upload:
   ```
   { url: "https://kangarugirls.sc.ke/uploads/file.jpg" }
   ```

3. **Frontend sends to** POST `/api/home-news` or `/api/student-life`:
   ```
   { imageUrl: "https://kangarugirls.sc.ke/uploads/file.jpg" }
   ```
...
- API Response: Convert to absolute based on request (`https://kangarugirls.sc.ke/uploads/file.jpg`)
...
```
Gallery attachments:    /uploads/... or https://kangarugirls.sc.ke/uploads/...
StudentLife items:      /images/... or https://kangarugirls.sc.ke/uploads/...
Events items:          /images/... or https://kangarugirls.sc.ke/uploads/...
Staff photos:          /images/staff/... or https://kangarugirls.sc.ke/uploads/...
HomeNews items:        https://kangarugirls.sc.ke/uploads/... (mostly absolute)
```
