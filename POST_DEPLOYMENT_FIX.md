...
- **Fixed**: 
  ...
  - Backend now allows requests from: `https://kangarugirls.sc.ke`
...
# CORS_ORIGINS=https://kangarugirls.sc.ke
```
...
NODE_ENV=production
CLIENT_ORIGIN=https://kangarugirls.sc.ke
CORS_ORIGINS=http://localhost:5173,http://localhost:4000,https://kangarugirls.sc.ke
```
