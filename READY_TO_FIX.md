...
2. Frontend fetches image URL from database: `https://kangarugirls.sc.ke/uploads/file.jpg`
...
2. Frontend receives: `https://kangarugirls.sc.ke/uploads/file.jpg`
...
- `https://kangarugirls.sc.ke/uploads/file.jpg` → `/uploads/file.jpg`
...
### Production:
```
POST /upload → Returns https://kangarugirls.sc.ke/uploads/file
↓ Normalized to: /uploads/file (stored in DB)
↓ Later: GET /api/gallery
↓ Returns: https://kangarugirls.sc.ke/uploads/file (absolute to production)
↓
