...
const StudentResults = ({ user }) => {
  ...
  const generatePDF = (result) => {
    ...
    doc.text("ST ANGELA NGUVIU GIRLS' SENIOR SCHOOL", pageWidth / 2, 20, { align: "center" });
    
    doc.setFontSize(12);
    doc.setFont("helvetica", "normal");
    doc.text("P.O. Box 123, Nguviu - Kenya", pageWidth / 2, 28, { align: "center" });
    doc.text("Tel: 0712-345-678 | Email: info@nguviu.ac.ke", pageWidth / 2, 35, { align: "center" });
